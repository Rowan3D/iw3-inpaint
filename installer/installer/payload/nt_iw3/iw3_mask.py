...
Set NT_MASK_DISABLE=1 to disable it, NT_MASK_DEBUG=1 to print what it marks on
the first few frames.

The threshold can be tuned without reinstalling: NT_MASK_GRAD (default 0.4),
NT_MASK_RUN, NT_MASK_GROW.
"""
